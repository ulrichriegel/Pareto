...
* `truncation_type = 'lp'`: Below the largest threshold $t_n$, the distribution function equals the distribution of the untruncated piecewise Pareto
                            distribution. The last Pareto piece, however, is truncated at `truncation`
